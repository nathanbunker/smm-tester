...
public class TestTransformer {
  private static final String REMOVE_REPEATS_MESSAGE =
      "MSH|^~\\&|||||20130823111809||VXU^V04^VXU_V04|X94P18|P|2.5.1|\r"
  ...
  public void testMapAddress() throws Exception {
    ...
    {
      connector.setCustomTransformations("NK1-1=[STREET]\n");
      String messageText = transformer.transform(connector, messageTextOriginal);
      assertFalse(messageText.equals(messageTextOriginal));
    }


    {
      connector.setCustomTransformations("NK1-1=[MAP 'Hi'=>[STREET]]\n");
      String messageText = transformer.transform(connector, messageTextOriginal);
      assertFalse(messageText.equals(messageTextOriginal));
      assertFalse(messageText.equals("MSH|\rPID|\rNK1|[STREET]|||\r"));
    }
  ...
  private static final String TEST_NMSIIS_1 =
      "MSH|^~\\&||718||NMSIIS|20120731085717||VXU^V04^VXU_V04|CI809903|P|2.5.1|||AL|AL|\r"
  ...
  private static final String TEST_NMSIIS_1_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20120731085717|CR|HL7.251.batch.txt||CI809903|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_1 =
      "MSH|^~\\&|||||20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_1_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700|CR|HL7.251.batch.txt||6882330-A1.2.8238|\r"
          ...
          + "PID|1||6882330-A1.2^^^OIS-TEST^MR||Durbin^Payge^Stefanie^^^^L|SMITH^KRISTI|20071202|F||2106-3^White^HL70005|18 Isdal Ln^^Casco Township^MI^48064^USA^P||^PRN^PH^^^810^4927434|||||||||2186-5^not Hispanic or Latino^CDCREC|\r"
          + "NK1|1|LOSSIAH^KRISTI^LYNN^^^|MTH^MOTHER^HL70063||||\r" + "IN1|1|\r" + "IN2|\r"
          + "ORC|RE||N89X3.3^OIS|||||||I-23432^Burden^Donna^A^^^^^NIST-AA-1||57422^RADON^NICHOLAS^^^^^^NIST-AA-1^L|\r"
          + "RXA|0|1|20141205||52^Hep A^CVX|0.5|mL^milliliters^UCUM||00^Administered^NIP001||||||Y11VA||SKB^GlaxoSmithKline^MVX||||A|\r"
          + "OBX|1|CE|64994-7^Vaccine funding program eligibility category^LN|1|V02^VFC eligible - Medicaid/Medicaid Managed Care^HL70064||||||F|||20141205|||VXC40^Eligibility captured at the immunization level^CDCPHINVS|\r"
          + "OBX|2|CE|30956-7^Vaccine Type^LN|2|85^Hepatitis A^CVX||||||F|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_2 =
      "MSH|^~\\&|||||20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_2_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700|CR|HL7.251.batch.txt||6882330-A1.2.8238|\r"
          + "BHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700||||6882330-A1.2.8238|\r"
          + "MSH|^~\\&|RPMS|||NMSIIS|20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
          + "PID|1||6882330-A1.2^^^OIS-TEST^MR||Durbin^Payge^Stefanie^^^^L|SMITH^KRISTI^STOWE|20071202|F||2106-3^White^HL70005|18 Isdal Ln^^Casco Township^MI^48064^USA^P||^PRN^PH^^^810^4927434|||||||||2186-5^not Hispanic or Latino^CDCREC|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_3 =
      "MSH|^~\\&|TEST EHR APPLICATION|X68||NIST TEST IZ REG|20130730091054|ASD123|VXU^V04^VXU_V04|-1140235900.5074|P|2.5.1|||AL|AL|\r"
  ...
  private static final String TEST_NMSIIS_CHILD_3_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20130730091054|CR|HL7.251.batch.txt||-1140235900.5074|\r"
          ...
          + "NK1|1|Clinton^Alex^CHESBIE^^^^L|MTH^MOTHER^HL70063|^^^^^USA^L|||NOK^NEXT OF KIN^99IHS\r"
          + "PV1|1|R|||||AB2001434^BEATTY,CINDY||AG2016752^GOVERNO,NANCY R|AMB|||||||||3252667|V01^20100115||||||||||||||||||||||||20100115\r"
          + "IN1|1|\r" + "IN2|\r" + "ORC|RE||9999^CDC\r"
          + "RXA|0|1|20110215|20110215|998^No vaccine administered^CVX|999||||||||||||||NA\r"
          + "OBX|1|CE|59784-9^Disease with presumed immunity ^LN|1|38907003^Varicella infection^SCT||||||F\r"
          + "BTS|1|CR|\r" + "FTS|1|CR|\r";

  private static final String TEST_NMSIIS_ADULT_1 =
      "MSH|^~\\&|||||20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
  ...
  private static final String TEST_NMSIIS_ADULT_1_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700|CR|HL7.251.batch.txt||6882330-A1.2.8238|\r"
          + "BHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700||||6882330-A1.2.8238|\r"
          + "MSH|^~\\&|RPMS|||NMSIIS|20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
  ...
  private static final String TEST_NMSIIS_ADULT_2 =
      "MSH|^~\\&|||||20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
          + "PID|1||6882330-A1.2^^^OIS-TEST^MR||Durbin^Payge^Stefanie^^^^L|SMITH^|19471202|F||2106-3^White^HL70005|18 Isdal Ln^^Casco Township^MI^48064^USA^P||^PRN^PH^^^810^4927434|||||||||2186-5^not Hispanic or Latino^CDCREC|\r"
          + "NK1|1|LOSSIAH^KRISTI^LYNN^^^|MTH^MOTHER^HL70063||||\r" + "IN1|1|\r" + "IN2|\r"
          + "ORC|RE||N89X3.3^OIS|||||||I-23432^Burden^Donna^A^^^^^NIST-AA-1||57422^RADON^NICHOLAS^^^^^^NIST-AA-1^L|\r"
  ...
  private static final String TEST_NMSIIS_ADULT_2_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700|CR|HL7.251.batch.txt||6882330-A1.2.8238|\r"
          + "BHS|^~\\&|RPMS|IHS2||NMSIIS|20141205054808-0700||||6882330-A1.2.8238|\r"
          + "MSH|^~\\&|RPMS|||NMSIIS|20141205054808-0700||VXU^V04^VXU_V04|6882330-A1.2.8238|P|2.5.1|\r"
          + "PID|1||6882330-A1.2^^^OIS-TEST^MR||Durbin^Payge^Stefanie^^^^L|SMITH^KRISTI|19471202|F||2106-3^White^HL70005|18 Isdal Ln^^Casco Township^MI^48064^USA^P||^PRN^PH^^^810^4927434|||||||||2186-5^not Hispanic or Latino^CDCREC|\r"
  ...
  private static final String TEST_ASIIS_1 =
      "MSH|^~\\&|||||20130820070412||VXU^V04^VXU_V04|Q43B1|P|2.5.1|\r"
          ...
          + "NK1|1|Lamar^Galatea|MTH^Mother^HL70063|\r" + "PV1|1|R|\r" + "ORC|RE||Q43B1.1^OIS|\r"
  ...
  private static final String TEST_ASIIS_1_RESULT =
      "MSH|^~\\&|RPMS||||20130820070412||VXU^V04^VXU_V04|Q43B1|P|2.5.1|\r"
          + "PID|1||Q43B1^^^OIS-TEST^MR||Richardson^Carmelo^F^^^^L|Lamar^Galatea|20130216|M|||1 Eastland Pl^^Portage^MI^49081^USA^P||^PRN^PH^^^269^7293157|\r"
          + "NK1|1|Lamar^Galatea|MTH^Mother^HL70063|\r" + "PV1|1|R|\r" + "ORC|RE||Q43B1.1^OIS|\r"
  ...
  private static final String TEST_NMSIIS_PROBLEM_1 =
      "MSH|^~\\&|RPMS|2011 DEMO HOSPITAL|||20140721165517||VXU^V04^VXU_V04|IHS-3908655|P|2.5.1|||AL|AL|\r"
  ...
  private static final String TEST_NMSIIS_PROBLEM_1_RESULT =
      "FHS|^~\\&|RPMS|IHS2||NMSIIS|20140721165517|CR|HL7.251.batch.txt||IHS-3908655|\r"
  ...
  public void testASIIS() throws Exception {
    ...
    connector
        .setCustomTransformations("MSH-3=RPMS\n" + "remove segment OBX all\n" + "RXA-4*=[RXA-3]\n");
    messageText = transformer.transform(connector, messageText);
