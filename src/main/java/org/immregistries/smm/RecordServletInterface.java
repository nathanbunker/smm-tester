...
public interface RecordServletInterface {
  ...
  public static final String VALUE_RESULT_ACK_CONFORMANCE_NOT_CONFIGURED_TO_RUN = "NOT CONFIGURED TO RUN";
  public static final String VALUE_RESULT_ACK_CONFORMANCE_RESPONSE_REDACTED = "RESPONSE REDACTED";
  public static final String VALUE_RESULT_ACK_CONFORMANCE_VALIDATION_RESOURCE_NOT_FOUND = "VALIDATION RESOURCE NOT FOUND";
  public static final String VALUE_RESULT_ACK_CONFORMANCE_VALIDATION_REPORT_IS_NULL = "VALIDATION REPORT IS NULL";
  ...
  public static final String VALUE_RESULT_QUERY_TYPE_PROFILE_ID_UNEXPECTED = "Profile Id Unexpected";
