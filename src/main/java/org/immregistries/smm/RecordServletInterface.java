...
public interface RecordServletInterface {
  ...
  public static final String[] PARAMS_TC = {PARAM_TC_PUBLIC_ID_CODE, PARAM_TC_ACCESS_PASSCODE,
      ...
      PARAM_TC_COUNT_UPDATE, PARAM_TC_COUNT_QUERY, PARAM_TC_PROFILE_BASE_NAME,
      PARAM_TC_PROFILE_COMPARE_NAME, PARAM_TC_PER_QUERY_TOTAL, PARAM_TC_PER_QUERY_COUNT,
      PARAM_TC_PER_QUERY_MIN, PARAM_TC_PER_QUERY_MAX, PARAM_TC_PER_QUERY_STD,
      PARAM_TC_PER_UPDATE_TOTAL, PARAM_TC_PER_UPDATE_COUNT, PARAM_TC_PER_UPDATE_MIN,
      PARAM_TC_PER_UPDATE_MAX, PARAM_TC_PER_UPDATE_STD};
