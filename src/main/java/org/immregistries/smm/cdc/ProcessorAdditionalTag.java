...
public class ProcessorAdditionalTag extends Processor {
  ...
  public static void printExplanation(PrintWriter out, String processorName) {
    ...
    out.println(
        "<p>This responds correctly except the response contains an additional tag that is not expected.  </p>");
  }
  ...
  public void doProcessMessage(PrintWriter out, SubmitSingleMessage ssm) throws Fault {
    ...
    out.println("]]></return>");
    out.println(
        "      <additionalUnexpectedTag reason=\"Receiving system is not expecting this tag this based on the WSDL\"/>");
