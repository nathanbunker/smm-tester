...
public class ScenarioManager {
  ...
  public static final String[] SCENARIOS = {SCENARIO_BLANK, SCENARIO_1_1_ADMIN_CHILD,
      SCENARIO_1_R_ADMIN_CHILD, SCENARIO_1_R_ADMIN_TWO_MONTHS_OLD, SCENARIO_1_R_ADMIN_TWO_YEARS_OLD,
      SCENARIO_1_R_ADMIN_FOUR_YEARS_OLD, SCENARIO_1_R_ADMIN_TWELVE_YEARS_OLD,
      SCENARIO_2_1_ADMIN_ADULT, SCENARIO_2_R_ADMIN_ADULT, SCENARIO_3_1_HISTORICAL_CHILD,
      SCENARIO_3_R_HISTORICAL_CHILD, SCENARIO_3_R_HISTORICAL_TWO_MONTHS_OLD,
      SCENARIO_3_R_HISTORICAL_TWO_YEARS_OLD, SCENARIO_3_R_HISTORICAL_FOUR_YEARS_OLD,
      SCENARIO_3_R_HISTORICAL_TWELVE_YEARS_OLD, SCENARIO_4_1_CONSENTED_CHILD,
      SCENARIO_4_R_CONSENTED_CHILD, SCENARIO_5_1_REFUSED_TODDLER, SCENARIO_5_R_REFUSED_TODDLER,
      SCENARIO_5_P_REFUSED_TODDLER, SCENARIO_6_1_VARICELLA_HISTORY_CHILD,
      SCENARIO_6_R_VARICELLA_HISTORY_CHILD, SCENARIO_6_P_VARICELLA_HISTORY_CHILD,
  ...
  public static TestCaseMessage createTestCaseMessage(String scenario) {
    ...
    if (scenario.equals(SCENARIO_BLANK)) {
      ...
      originalMessage = "MSH|\nPID|\nPD1|\nNK1|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\n";
      quickTransformations = new String[] {"2.5.1", "BOY_OR_GIRL", "DOB", "ADDRESS", "PHONE",
          "MOTHER", "RACE", "ETHNICITY", "VAC1_ADMIN"};
      ...
      originalMessage =
          "MSH|\nPID|\nPD1|\nNK1|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\nORC|\nRXA|\n";
      quickTransformations = new String[] {"2.5.1", "BOY_OR_GIRL", "DOB", "ADDRESS", "PHONE",
          "MOTHER", "RACE", "ETHNICITY", "VAC1_ADMIN", "VAC1_DELETE"};
      patientType = PatientType.TODDLER;
      ...
      patientType = PatientType.TODDLER;
      quickTransformations = new String[] {"2.5.1", "BOY_OR_GIRL", "DOB", "ADDRESS", "PHONE",
          "RACE", "ETHNICITY", "VAC1_NA", "VAC2_ADMIN"};
      customTransformations =
          "RXA-18.1=00\n" + "RXA-18.2=Parental Decision\n" + "RXA-18.3=NIP002\n" + "RXA-20=RE\n";
      ...
      originalMessage =
          "MSH|\nPID|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\nORC|\nRXA|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\n";
      quickTransformations = new String[] {"2.5.1", "BOY_OR_GIRL", "DOB", "ADDRESS", "PHONE",
          "RACE", "ETHNICITY", "VAC1_ADMIN", "VAC2_HIST", "VAC3_ADMIN"};
      patientType = PatientType.TODDLER;
      ...
      originalMessage =
          "MSH|\nPID|\nPD1|\nNK1|\nPV1|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\nORC|\nRXA|\nORC|\nRXA|\nRXR|\nOBX|\nOBX|\nOBX|\nOBX|\n";
      quickTransformations = new String[] {"2.5.1", "BOY_OR_GIRL", "DOB", "ADDRESS", "PHONE",
          "MOTHER", "RACE", "ETHNICITY", "VAC1_ADMIN", "VAC2_HIST", "VAC3_ADMIN"};
      patientType = PatientType.TODDLER;
      customTransformations =
      ...
      originalMessage =
          "MSH|^~\\&|Test EHR Application|X68||NIST Test Iz Reg|201207010822||VXU^V04^VXU_V04|NIST-IZ-004.00|P|2.5.1|||AL|ER\n"
      ...
      originalMessage =
          "MSH|^~\\&|Test EHR Application|X68||NIST Test Iz Reg|201207010822||VXU^V04^VXU_V04|NIST-IZ-007.00|P|2.5.1|||AL|ER\n"
      ...
      originalMessage =
          "MSH|^~\\&|Test EHR Application|X68||NIST Test Iz Reg|201207010822||VXU^V04^VXU_V04|NIST-IZ-010.00|P|2.5.1|||AL|ER\n"
