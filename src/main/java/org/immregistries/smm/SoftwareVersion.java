...
public class SoftwareVersion
{
  ...
  public static String VERSION_FOR_TESTER_DOWNLOAD = "2.0.7";
  
  public static String SOFTWARE_VENDOR = "AIRA";
  public static String SOFTWARE_PRODUCT_NAME = "SMM/Tester";
  public static String SOFTWARE_BINARY_ID = "139032";
  public static String SOFTWARE_RELEASE_DATE = "20170131";
