...
public class SoftwareVersion
{
  ...
  public static String VERSION_FOR_TESTER_DOWNLOAD = "2.0.9";
  
  public static String SOFTWARE_VENDOR = "AIRA";
  public static String SOFTWARE_PRODUCT_NAME = "SMM/Tester";
  public static String SOFTWARE_BINARY_ID = "139034";
  public static String SOFTWARE_RELEASE_DATE = "20170214";
