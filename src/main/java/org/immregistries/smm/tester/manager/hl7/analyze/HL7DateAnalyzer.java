package org.immregistries.smm.tester.manager.hl7.analyze;

import org.immregistries.smm.tester.manager.hl7.HL7Component;

public class HL7DateAnalyzer extends HL7FormatAnalyzer
{
  private int year = 0;
  private int month = 0;
  private int day = 0;
  ...
  public HL7DateAnalyzer(HL7Component component) {
    super(component);
  }

  public void analyze() {
    String time = component.getValue();
    if (year == 0 && !time.equals("")) {
      try {
        ...
        errorMessageList
            .add("Format of date/time does not conform to DTM definition, cannot be converted into numeric values");
      }
