                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":submitSingleMessageResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "submitSingleMessageResponse",
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"submitSingleMessageResponse".equals(type)){
                                ...
                                return (SubmitSingleMessageResponse)org.immregistries.smm.tester.connectors.fl.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
