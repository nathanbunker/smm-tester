...
public class NMSoapConnector extends HttpConnector
{
  ...
  public String submitMessage(String message, boolean debug) throws Exception
  {
    ...
    org.immregistries.smm.tester.connectors.tlep.SubmitSingleMessage submitSingleMessage = new org.immregistries.smm.tester.connectors.tlep.SubmitSingleMessage();
    org.immregistries.smm.tester.connectors.tlep.SubmitSingleMessageRequestType request = new org.immregistries.smm.tester.connectors.tlep.SubmitSingleMessageRequestType();
    ...
    org.immregistries.smm.tester.connectors.tlep.SubmitSingleMessageResponse response = clientService.submitSingleMessage(submitSingleMessage);
  ...
  public String connectivityTest(String message) throws Exception
  {
    ...
    org.immregistries.smm.tester.connectors.tlep.ConnectivityTest connectivityTest = new org.immregistries.smm.tester.connectors.tlep.ConnectivityTest();
    connectivityTest.setConnectivityTest(request);
    org.immregistries.smm.tester.connectors.tlep.ConnectivityTestResponse response = clientService.connectivityTest(connectivityTest);
