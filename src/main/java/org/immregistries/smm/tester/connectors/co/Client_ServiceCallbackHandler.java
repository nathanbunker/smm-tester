...
public abstract class Client_ServiceCallbackHandler {
    ...
    public void receiveResultsubmitSingleMessage(
        org.immregistries.smm.tester.connectors.co.Client_ServiceStub.SubmitSingleMessageResponse result) {
    }
    ...
    public void receiveResultconnectivityTest(
        org.immregistries.smm.tester.connectors.co.Client_ServiceStub.ConnectivityTestResponse result) {
    }
