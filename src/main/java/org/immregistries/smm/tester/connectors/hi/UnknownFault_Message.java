...
public class UnknownFault_Message extends java.lang.Exception{
    ...
    private org.immregistries.smm.tester.connectors.hi.Fault faultMessage;
    ...
    public void setFaultMessage(org.immregistries.smm.tester.connectors.hi.Fault msg){
       faultMessage = msg;
    }
    
    public org.immregistries.smm.tester.connectors.hi.Fault getFaultMessage(){
       return faultMessage;
    }
}
