...
/**
 * ConnectivityTestFLResponse.java
 *
...
/**
 * ConnectivityTestFLResponse bean class
 */
@SuppressWarnings({"all"})

public class ConnectivityTestFLResponse implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:cdc:iisb:2011", "connectivityTestFLResponse", "ns1");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            namespacePrefix + ":connectivityTestFLResponse", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            "connectivityTestFLResponse", xmlWriter);
      }
  ...
  public static class Factory {
     ...
     */
    public static ConnectivityTestFLResponse parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      ConnectivityTestFLResponse object = new ConnectivityTestFLResponse();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"connectivityTestFLResponse".equals(type)) {
              // find namespace for the prefix
              java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
              return (ConnectivityTestFLResponse) org.immregistries.smm.tester.connectors.fl.ExtensionMapper
