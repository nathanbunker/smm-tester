...
public class MessageTooLargeFault_Message extends java.lang.Exception{
    ...
    private org.immunizationsoftware.dqa.tester.connectors.hi.MessageTooLargeFault faultMessage;
    ...
    public void setFaultMessage(org.immunizationsoftware.dqa.tester.connectors.hi.MessageTooLargeFault msg){
       faultMessage = msg;
    }
    
    public org.immunizationsoftware.dqa.tester.connectors.hi.MessageTooLargeFault getFaultMessage(){
       return faultMessage;
    }
}
