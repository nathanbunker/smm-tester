...
public class UnknownFaultMessage extends java.lang.Exception {
    ...
    private org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.Fault faultMessage;
    ...
    public void setFaultMessage(org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.Fault msg) {
        faultMessage = msg;
    }

    public org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.Fault getFaultMessage() {
        return faultMessage;
    }
}
