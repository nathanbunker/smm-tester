   ...
   public RhapWSUAT_EHR_IISStub(org.apache.axis2.context.ConfigurationContext configurationContext,
    ...
    public RhapWSUAT_EHR_IISStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     * @see org.immunizationsoftware.dqa.tester.connectors.nm.RhapWSUAT_EHR_IIS#submitSingleMessage
            ...
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"submitSingleMessage"))){
                    ...
                    try{
                        ...
                        if (ex instanceof org.immunizationsoftware.dqa.tester.connectors.nm.SubmitSingleMessageFault){
                          throw (org.immunizationsoftware.dqa.tester.connectors.nm.SubmitSingleMessageFault)ex;
                        }
                ...
                * submit single message
                * @see org.immunizationsoftware.dqa.tester.connectors.nm.RhapWSUAT_EHR_IIS#startsubmitSingleMessage
                    * @param submitSingleMessage4
									...
									if (faultElt!=null){
										if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"submitSingleMessage"))){
											...
											try{
													...
													if (ex instanceof org.immunizationsoftware.dqa.tester.connectors.nm.SubmitSingleMessageFault){
														callback.receiveErrorsubmitSingleMessage((org.immunizationsoftware.dqa.tester.connectors.nm.SubmitSingleMessageFault)ex);
											            return;
										            }
        ...
        if ( _operations[0].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[0].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     * @see org.immunizationsoftware.dqa.tester.connectors.nm.RhapWSUAT_EHR_IIS#connectivityTest
            ...
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"connectivityTest"))){
                    ...
                    try{
                        ...
                        if (ex instanceof org.immunizationsoftware.dqa.tester.connectors.nm.ConnectivityTestFault){
                          throw (org.immunizationsoftware.dqa.tester.connectors.nm.ConnectivityTestFault)ex;
                        }
                ...
                * Auto generated method signature for Asynchronous Invocations
                * the connectivity test
                * @see org.immunizationsoftware.dqa.tester.connectors.nm.RhapWSUAT_EHR_IIS#startconnectivityTest
                    * @param connectivityTest6
									...
									if (faultElt!=null){
										if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"connectivityTest"))){
											...
											try{
													...
													if (ex instanceof org.immunizationsoftware.dqa.tester.connectors.nm.ConnectivityTestFault){
														callback.receiveErrorconnectivityTest((org.immunizationsoftware.dqa.tester.connectors.nm.ConnectivityTestFault)ex);
											            return;
										            }
