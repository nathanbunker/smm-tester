...
public class CreateTestCaseServlet extends ClientServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("          <td><input type=\"text\" name=\"testCase\" value=\"" + testCaseMessage.getTestCaseNumber() + "\" size=\"15\"> Set <input type=\"text\" name=\"testCaseSet\" value=\"" + testCaseMessage.getTestCaseSet() + "\" size=\"15\"></td>");
            ...
            out.println("          <td colspan=\"2\"><input type=\"text\" name=\"description\" value=\"" + testCaseMessage.getDescription() + "\" size=\"70\"></td>");
            out.println("        </tr>");
            out.println("        <tr>");
            out.println("          <td valign=\"top\">Expected Result</td>");
            out.println("          <td colspan=\"2\"><input type=\"text\" name=\"expectedResult\" value=\"" + testCaseMessage.getExpectedResult() + "\" size=\"70\"></td>");
            out.println("        </tr>");
            out.println("        <tr>");
            ...
            out.println("              <option value=\"Accept\"" + (testCaseMessage.getAssertResultStatus().equals("Accept") ? " selected=\"true\"" : "") + ">Accept</option>");
            out.println("              <option value=\"Accept and Warn\"" + (testCaseMessage.getAssertResultStatus().equals("Accept and Warn") ? " selected=\"true\"" : "") + ">Accept and Warn</option>");
            out.println("              <option value=\"Reject\"" + (testCaseMessage.getAssertResultStatus().equals("Reject") ? " selected=\"true\"" : "") + ">Reject</option>");
            out.println("            </select>");
            out.println("            Value <input type=\"text\" name=\"assertResultText\" value=\"" + testCaseMessage.getAssertResultText() + "\" size=\"50\">");
            out.println("          </td>");
            out.println("        </tr>");
            if (!testCaseMessage.getActualResultAckType().equals("")) {
                out.println("        <tr>");
                out.println("          <td>Actual Result</td>");
                out.println("          <td colspan=\"2\">" + testCaseMessage.getActualResultAckType() + ": " + testCaseMessage.getActualResultAckMessage() + "</td>");
                out.println("        </tr>");
            }
            out.println("        <tr>");
            out.println("          <td valign=\"top\">Start Message</td>");
            out.println("          <td colspan=\"2\"><textarea name=\"base\" cols=\"70\" rows=\"7\" wrap=\"off\">" + testCaseMessage.getOriginalMessage() + "</textarea></td>");
            out.println("        </tr>");
            out.println("        <tr>");
            ...
            out.println("                  <input type=\"checkbox\" name=\"extra\" value=\"2.5.1\"" + isChecked("2.5.1", testCaseMessage.getQuickTransformations()) + "> 2.5.1 <input type=\"checkbox\" name=\"extra\" value=\"2.3.1\"" + isChecked("2.3.1", testCaseMessage.getQuickTransformations()) + "> 2.3.1<br>");
            ...
            out.println("                  <input type=\"checkbox\" name=\"extra\" value=\"DOB\"" + isChecked("DOB", testCaseMessage.getQuickTransformations()) + "> Date of Birth <input type=\"checkbox\" name=\"extra\" value=\"TWIN_POSSIBLE\"" + isChecked("TWIN_POSSIBLE", testCaseMessage.getQuickTransformations()) + "> Twin Possible<br>");
            out.println("                  <input type=\"checkbox\" name=\"extra\" value=\"ADDRESS\"" + isChecked("ADDRESS", testCaseMessage.getQuickTransformations()) + "> Address <input type=\"checkbox\" name=\"extra\" value=\"PHONE\"" + isChecked("PHONE", testCaseMessage.getQuickTransformations()) + "> Phone<br>");
            out.println("                  <input type=\"checkbox\" name=\"extra\" value=\"MOTHER\"" + isChecked("MOTHER", testCaseMessage.getQuickTransformations()) + "> Mother <input type=\"checkbox\" name=\"extra\" value=\"FATHER\"" + isChecked("FATHER", testCaseMessage.getQuickTransformations()) + "> Father<br>");
            out.println("                  <input type=\"checkbox\" name=\"extra\" value=\"RACE\"" + isChecked("RACE", testCaseMessage.getQuickTransformations()) + "> Race <input type=\"checkbox\" name=\"extra\" value=\"ETHNICITY\"" + isChecked("ETHNICITY", testCaseMessage.getQuickTransformations()) + "> Ethnicity<br>");
            out.println("                  Vacc #1 <input type=\"checkbox\" name=\"extra\" value=\"VAC1_ADMIN\"" + isChecked("VAC1_ADMIN", testCaseMessage.getQuickTransformations()) + "> Admin <input type=\"checkbox\" name=\"extra\" value=\"VAC1_HIST\"" + isChecked("VAC1_HIST", testCaseMessage.getQuickTransformations()) + "> Hist<br>");
            out.println("                  Vacc #2 <input type=\"checkbox\" name=\"extra\" value=\"VAC2_ADMIN\"" + isChecked("VAC2_ADMIN", testCaseMessage.getQuickTransformations()) + "> Admin <input type=\"checkbox\" name=\"extra\" value=\"VAC2_HIST\"" + isChecked("VAC2_HIST", testCaseMessage.getQuickTransformations()) + "> Hist<br>");
            out.println("                  Vacc #3 <input type=\"checkbox\" name=\"extra\" value=\"VAC3_ADMIN\"" + isChecked("VAC3_ADMIN", testCaseMessage.getQuickTransformations()) + "> Admin <input type=\"checkbox\" name=\"extra\" value=\"VAC3_HIST\"" + isChecked("VAC3_HIST", testCaseMessage.getQuickTransformations()) + "> Hist<br>");
            out.println("                  <div class=\"smallTitle\">Custom Transforms</div>");
            out.println("                  <textarea name=\"customTransforms\" cols=\"30\" rows=\"4\" wrap=\"off\">" + testCaseMessage.getCustomTransformations() + "</textarea>");
            out.println("                </td>");
            out.println("                <td valign=\"top\">");
            out.println("                  <div class=\"smallTitle\">Quick Transforms Applied</div> ");
            out.println("                  <pre style=\"text-align: left; height: 270px; width: 250px;overflow:auto;\">" + testCaseMessage.getQuickTransformationsConverted() + "</pre>");
            out.println("                </td>");
            out.println("              </tr>");
            out.println("            </table>");
            out.println("          </td>");
            ...
            out.println("          <td colspan=\"2\"><pre style=\"text-align: left; height: 250px; width: 520px;overflow:auto;\">" + testCaseMessage.createText(true) + "</pre></td>");
            out.println("        </tr>");
            out.println("        <tr>");
