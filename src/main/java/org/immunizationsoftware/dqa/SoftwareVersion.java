...
public class SoftwareVersion
{
  ...
  public static String VERSION_FOR_TESTER_DOWNLOAD = "1.74";
  
  public static String SOFTWARE_VENDOR = "OIS";
  public static String SOFTWARE_PRODUCT_NAME = "IIS Tester - Simple Message Mover";
  public static String SOFTWARE_BINARY_ID = "139025";
  public static String SOFTWARE_RELEASE_DATE = "20160921";
}
