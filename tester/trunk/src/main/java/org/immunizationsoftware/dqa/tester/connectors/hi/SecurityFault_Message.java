...
public class SecurityFault_Message extends java.lang.Exception{
    ...
    private org.immunizationsoftware.dqa.tester.connectors.hi.SecurityFault faultMessage;
    ...
    public void setFaultMessage(org.immunizationsoftware.dqa.tester.connectors.hi.SecurityFault msg){
       faultMessage = msg;
    }
    
    public org.immunizationsoftware.dqa.tester.connectors.hi.SecurityFault getFaultMessage(){
       return faultMessage;
    }
}
