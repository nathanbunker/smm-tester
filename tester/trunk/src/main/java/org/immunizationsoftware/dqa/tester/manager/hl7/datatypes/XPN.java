...
public class XPN extends HL7Component
{
  ...
  public void init() {
    ...
    setChild(2, givenName = new ST("Given Name", UsageType.R, 30));
    setChild(3, secondAndFurtherGivenNamesOrInitialsTherof = new ST("Second and Further Given Names or Intials Therof", UsageType.RE, 30));
