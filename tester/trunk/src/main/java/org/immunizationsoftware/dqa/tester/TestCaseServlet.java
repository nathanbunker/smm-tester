      ...
      try {
        ...
        for (TestCaseMessage testCaseMessage : testCaseMessageList) {
          try {
            ...
            out.println("</tr>");
            out.println("</table>");
            out.println("<div id=\"" + testCaseMessage.getTestCaseNumber() + "\" "
                + (testCaseMessageList.size() == 1 ? "" : "style=\"display:none\"") + ">");
            out.println("<table width=\"700\">");
            out.println("<tr>");
            out.println("<th nowrap align=\"left\" valign=\"top\">Description</th><td>"
                + testCaseMessage.getDescription() + "</td>");
            out.println("</td>");
            out.println("</tr>");
            out.println("<tr>");
            ...
            if (!testCaseMessage.getCustomTransformations().equals("")) {
              out.println("<tr>");
              out.println("<th nowrap align=\"left\" valign=\"top\">Changes</th><td><pre>"
            ...
            if (!testCaseMessage.getCauseIssues().equals("")) {
              ...
              out.println("<th nowrap align=\"left\" valign=\"top\">Issues</th><td><pre>"
                  + testCaseMessage.getCauseIssues() + "</pre></td>");
              out.println("</tr>");
            }
            out.println("</table>");
