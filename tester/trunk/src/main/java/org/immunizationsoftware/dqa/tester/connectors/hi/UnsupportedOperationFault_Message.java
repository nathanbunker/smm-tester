...
public class UnsupportedOperationFault_Message extends java.lang.Exception{
    ...
    private org.immunizationsoftware.dqa.tester.connectors.hi.UnsupportedOperationFault faultMessage;
    ...
    public void setFaultMessage(org.immunizationsoftware.dqa.tester.connectors.hi.UnsupportedOperationFault msg){
       faultMessage = msg;
    }
    
    public org.immunizationsoftware.dqa.tester.connectors.hi.UnsupportedOperationFault getFaultMessage(){
       return faultMessage;
    }
}
