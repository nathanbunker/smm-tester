...
public class SecurityFaultMessage extends java.lang.Exception {
    ...
    private org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.SecurityFault faultMessage;
    ...
    public void setFaultMessage(
        org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.SecurityFault msg) {
        faultMessage = msg;
    }

    public org.immunizationsoftware.dqa.tester.connectors.co.Client_ServiceStub.SecurityFault getFaultMessage() {
        return faultMessage;
    }
}
