...
public class MessageTooLargeFault_Message extends java.lang.Exception{
    ...
    private org.immunizationsoftware.dqa.tester.connectors.tlep.MessageTooLargeFault faultMessage;
    ...
    public void setFaultMessage(org.immunizationsoftware.dqa.tester.connectors.tlep.MessageTooLargeFault msg){
       faultMessage = msg;
    }
    
    public org.immunizationsoftware.dqa.tester.connectors.tlep.MessageTooLargeFault getFaultMessage(){
       return faultMessage;
    }
}
