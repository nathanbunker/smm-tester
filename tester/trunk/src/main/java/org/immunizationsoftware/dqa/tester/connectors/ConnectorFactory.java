...
public class ConnectorFactory {
  ...
  public static final String[][] TYPES = { { TYPE_SOAP, "SOAP" }, { TYPE_POST, "POST" }, { TYPE_CA_SOAP, "CA SOAP" }, { TYPE_MO_SOAP, "MO SOAP" },{ TYPE_ND_SOAP, "ND SOAP" },
      { TYPE_NM_SOAP, "NM SOAP" }, { TYPE_ENVISION_SOAP, "Envision SOAP" }, { TYPE_HI_SOAP, "HI SOAP (same standard as SOAP)" },
      { TYPE_IL_WS, "IL WS" } };
